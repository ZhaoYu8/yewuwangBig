...
instance.interceptors.response.use((response) => {
  ...
  if (error.response) {
    errorMessage = error.response.data === null ? '系统内部异常，请联系网站管理员' : error.response.data.error.message
